...
export const DEFAULT_HOME_CONFIGURATION: GuideHomeConfiguration = {
  ...
  tiles: [
    ...
    { id: "know", title: "Bon à savoir", subtitle: "Infos & règles du logement", image: "", visible: true, size: "normal", position: 2 },
    { id: "minibar", title: "Mini bar / Boutique", subtitle: "Boissons, snacks & dépannage", image: "", visible: true, size: "normal", position: 3 },
    ...
    { id: "activities", title: "À découvrir", subtitle: "Visites et activités", image: "https://images.unsplash.com/photo-1528127269322-539801943592?auto=format&fit=crop&w=900&q=85", visible: true, size: "normal", position: 6 },
