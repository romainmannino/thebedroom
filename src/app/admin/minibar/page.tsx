...
export default function AdminMinibarPage() {
  ...
  function addProduct() {
    ...
    setCatalog((prev) => ({ ...prev, products: [...prev.products, { id, name: "Nouvel article", description: "Description", priceCents: 300, image: "", active: true, position: prev.products.length, category: "Autres" }] }));
  }
  ...
  const products = [...catalog.products].sort((a,b) => a.position-b.position);
    ...
    <div className="mx-auto max-w-[1100px] overflow-hidden rounded-[28px] bg-[#faf8f4] shadow-xl">
      ...
      <section className="p-4 sm:p-7">
        ...
        <div className="mt-7 grid gap-4 md:grid-cols-2">
          {products.map((product) => <article key={product.id} className="overflow-hidden rounded-[24px] bg-white shadow-sm">
